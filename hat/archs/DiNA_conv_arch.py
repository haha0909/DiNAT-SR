...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=StarReLU, drop=0.):
        super().__init__()
...
class DiNAT_s(nn.Module):
    def __init__(
        ...
        for i_layer in range(self.num_layers):
            ...
            # patch merging layer
            if downsample is not None:
                self.downsample = downsample(input_resolution, dim=embed_dim, norm_layer=norm_layer)
            else:
                self.downsample = None
